...
>(({ className, ...props }, ref) => {
  ...
  return (
    <div
      ref={ref}
      className={cn(
        'relative h-2 w-96 max-w-full overflow-hidden rounded-md bg-gray-500',
        className,
      )}
      {...props}
    >
      <div
        className="absolute top-0 bottom-0 -left-full w-full bg-black transition-transform dark:bg-white"
